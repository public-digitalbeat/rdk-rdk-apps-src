...
/**
 * Class for Factory Reset Confirmation Screen.
 */
export default class FactoryResetConfirmationScreen extends Lightning.Component {
        ...
        return {
            ...
            FactoryResetScreen: {
                ...
                Title: {
                    ...
                    mountX: 0.5,
                    text: {
                        text: Language.translate("FactoryReset"),
                ...
                Info: {
                    ...
                    mountX: 0.5,
                    text: {
                        text: Language.translate("Click Confirm to factory reset!"),
                        fontFace: CONFIG.language.font,
                        fontSize: 25,
                    },
                },
    ...
    static _states() {
        return [
            ...
            class Resetting extends this {
                $enter() {
                    this.loadingAnimation.start()
                    this.tag("Loader").visible = true
                    this.tag("Title").text.text = "Resetting to factory settings ..."
