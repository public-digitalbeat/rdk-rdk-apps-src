...
/**
 * Class for the item in the Display screen.
 */
export default class DisplayItem extends SettingsItem {
  static _template() {
    return {
      Item: {
        w: 1920 / 3 - 70,
  ...
  /**
   * Function to set contents of an item in the Display screen.
   */
  set item(item) {
    this._item = item
