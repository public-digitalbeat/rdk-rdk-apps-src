/**
 * App version: 1.0 30/12/21
 * SDK version: 4.8.3
 * CLI version: 2.7.2
 *
 * Generated: Thu, 02 Jun 2022 23:35:44 GMT
 */
...
var APP_Foreground = (function () {
  ...
  const replaceHistoryState = (state, hash) => {
    if (!history.length) {
      return;
    }
  ...
  var thunderJS = options => {
    ...
    return wrapper({ ...thunder$1(options),
      ...plugins
    });
  };
  ...
  const thunder$1 = options => ({
    ...
    registerPlugin(name, plugin) {
      this[name] = wrapper(Object.assign(Object.create(thunder$1), plugin, {
        plugin: name
      }));
    },
      ...
      get(target, propKey) {
        ...
        if (typeof prop !== 'undefined') {
          ...
          if (typeof prop === 'object') {
            return wrapper(Object.assign(Object.create(thunder$1(target.options)), prop, {
              plugin: propKey
            }));
          }
          ...
          if (target.plugin === false) {
            return wrapper(Object.assign(Object.create(thunder$1(target.options)), {}, {
              plugin: propKey
            }));
          }
  ...
  class AppApi {
    ...
    getConnectedAudioPorts() {
      return new Promise((resolve, reject) => {
        thunder.call('org.rdk.DisplaySettings.1', 'getConnectedAudioPorts', {}).then(result => {
          resolve(result);
        }).catch(err => {
    ...
    getVolumeLevel(port) {
      return new Promise((resolve, reject) => {
        thunder.call('org.rdk.DisplaySettings.1', 'getVolumeLevel', {
          audioPort: port
        }).then(result => {
          resolve(result);
        }).catch(err => {
    ...
    setVolumeLevel(port, volume) {
      return new Promise((resolve, reject) => {
        thunder.call('org.rdk.DisplaySettings.1', 'setVolumeLevel', {
          audioPort: port,
          volumeLevel: volume
        }).then(result => {
    ...
    audio_mute(audio_source, value) {
      return new Promise((resolve, reject) => {
        thunder.call('org.rdk.DisplaySettings.1', 'setMuted', {
    ...
    muteStatus(port) {
      return new Promise((resolve, reject) => {
        thunder.call('org.rdk.DisplaySettings.1', 'getMuted', {
          audioPort: port
        }).then(result => {
          resolve(result);
        }).catch(err => {
    ...
    setVisibility(client, visible) {
      return new Promise((resolve, reject) => {
        ...
        if (visible) {
          thunder.call('org.rdk.RDKShell.1', 'setFocus', {
            client: client
          }).then(res => {
            resolve(true);
          }).catch(err => {
          ...
          thunder.call('org.rdk.RDKShell.1', 'getZOrder').then(result => {
            ...
            thunder.call('org.rdk.RDKShell.1', 'setFocus', {
              client: result.clients[this.index + 1] ? result.clients[this.index + 1] : result.clients[this.index - 1]
            }).then(() => {
              resolve(true);
            }).catch(err => {
              console.log('Set focus error', JSON.stringify(err));
  ...
  class App extends Lightning.Component {
    ...
    static _states() {
      return [class Control extends this {
        _handleKey(key) {
          if (key.keyCode === keyMap.AudioVolumeUp) {
            ...
            if (this.volume < 100) {
              this.volume += 10;
              this.appApi.setVolumeLevel(this.audioport, this.volume);
              this.updateVolume(this.volume);
          ...
          if (key.keyCode === keyMap.AudioVolumeMute) {
            ...
            this.appApi.audio_mute(this.audioport, !this.mute).then(res => {
              if (res.success) {
                this.mute = !this.mute;
